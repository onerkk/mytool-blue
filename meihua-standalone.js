...
(function () {
  ...
  function buildMeihuaPrompt(question, mh) {
    ...
    if(window.JY_READING_QUALITY)L=L.concat(window.JY_READING_QUALITY.lines('meihua'));
    L.push('【判讀方法】');
    ...
    L.push(window.JY_READING_QUALITY&&window.JY_READING_QUALITY.recommendationEnding?window.JY_READING_QUALITY.recommendationText('meihua'):JY_REC_MEIHUA);
    L.push('最後保留以下兩行：');
