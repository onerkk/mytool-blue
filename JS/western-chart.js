...
(function(root){
 ...
 function wheel(chart,{selected='Sun',interactive=true,id='wx-wheel',light=false}={}){
  ...
  let s='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 600" class="wx-chart-svg" role="img" aria-label="回歸黃道西洋星盤" style="font-family:Georgia,serif"><defs><radialGradient id="'+id+'-face"><stop stop-color="'+(light?'#fbf2db':'#192b44')+'"/><stop offset="1" stop-color="'+(light?'#ddcba8':'#091624')+'"/></radialGradient></defs><circle cx="300" cy="300" r="289" fill="url(#'+id+'-face)" stroke="'+gold+'" stroke-width="3"/>';
  ...
  s+=text('✦',[300,288],24,gold)+text(chart.sensitivity.unknownTime?'星位參考':'NATAL',[300,316],11,gold,'letter-spacing="3"');
