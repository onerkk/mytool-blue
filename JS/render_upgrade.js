...
function renderBaziUpgrade(){
  ...
  if(b.zhengGe){
    var ge=b.zhengGe;
    html+='<div style="'+_U.card+'var(--c-gold,#c9a84c)">';
  ...
  if(b.tenGodCombos&&b.tenGodCombos.length){
    html+='<div style="'+_U.card+'#c9a84c">';
    html+='<div style="'+_U.title+'color:#c9a84c">十神組合格局</div>';
  ...
  if(b.extraShenSha&&b.extraShenSha.length){
    html+='<div style="'+_U.card+'rgba(201,168,76,.4)">';
...
function renderNatalUpgrade(){
  ...
  if(n.aspectPatterns&&n.aspectPatterns.length){
    html+='<div style="'+_U.card+'#c9a84c">';
    html+='<div style="'+_U.title+'color:#c9a84c">相位圖形</div>';
    html+='<div style="'+_U.body+'">';
...
function renderJyotishUpgrade(){
  ...
  if(j.currentPD){
    html+='<div style="'+_U.card+'#c9a84c">';
    html+='<div style="'+_U.title+'color:#c9a84c">第三層小運（Pratyantardasha）</div>';
...
function renderTarotUpgrade(){
  ...
  if(ta.numerology){
    ...
    html+='<div style="'+_U.card+'#c9a84c">';
    html+='<div style="'+_U.title+'color:#c9a84c">🔢 牌號數字學</div>';
...
function renderMeihuaUpgrade(){
  ...
  if(mh.dongYaoDeep){
    html+='<div style="'+_U.card+'#c9a84c">';
    html+='<div style="'+_U.title+'color:#c9a84c">📍 動爻詳解</div>';
...
function renderNameUpgrade(){
  ...
  if(nr.sanCaiDetail){
    html+='<div style="'+_U.card+'#c9a84c">';
    html+='<div style="'+_U.title+'color:#c9a84c">三才配置解讀（'+(nr.sanCai||[]).join('')+'→'+nr.sanCaiLevel+'）</div>';
