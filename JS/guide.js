...
h+='<div class="mn-tl hi"><div class="ico">⭐</div><div><div class="nm">塔羅快讀</div><div class="ds">一個問題，抽牌就有答案<br>不需任何資料・只要問題和選牌</div><div class="bg">每日免費一次 ＋ 追問免費一次</div></div></div>';
h+='<div class="mn-tl"><div class="ico">🔑</div><div><div class="nm">開鑰之法</div><div class="ds">78 張牌五層深潛，問到根源<br>需出生資料・金色黎明最高階</div><div class="bg">每日免費一次 ＋ 追問免費一次</div></div></div>';
h+='<div class="mn-tl"><div class="ico">🌙</div><div><div class="nm">七維度交叉分析</div><div class="ds">七套命理系統交叉比對<br>需出生資料・八字 紫微 梅花 塔羅 星盤 吠陀 姓名</div><div class="bg">每日免費一次 ＋ 追問免費一次</div></div></div>';
h+='</div></div>';
...
h+='</div>';
h+='<div class="jy-tip"><div class="ic">⚠️</div><div class="tx">輸入追問，點「抽補充牌」<small>靜月會結合原本分析 + 新的補充牌一起回答<br>每天免費一次＋追問也免費一次<br>會員每日 5 次</small></div></div>';
h+='</div>';
