...
(function () {
  ...
  function recommendationFragment(tool) {
    return window.JY_READING_QUALITY&&window.JY_READING_QUALITY.version==="4.2.0"&&window.JY_READING_QUALITY.recommendationEnding?window.JY_READING_QUALITY.recommendationEnding(tool):JY_REC_EXPORT[tool];
  }
  ...
  function buildPrompt(tool, suppliedPayload) {
    ...
    return [
      ...
      (window.JY_READING_QUALITY?window.JY_READING_QUALITY.lines(tool):JY_READING_EXPORT[tool]).join('\n'),
