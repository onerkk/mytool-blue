/*! prompt-export.js — 靜月之光 前端提示詞匯出引擎  [v80.6]
 *  v80.6（暗戀/喜歡題防過度斷言修正）：
...
(function () {
  ...
  var FRAG_CRUSH_LIMIT =
    '・暗戀/好感題硬限制：本題若問「有沒有人暗戀我／某人是否喜歡我／公司是否有人對我有意思」，第一句必須區分「注意/好感跡象」與「明確暗戀」。只有宮廷牌、聖杯牌、戀人/太陽/月亮等感情或吸引訊號互相支撐，且沒有被阻礙位或結果位明顯壓住時，才能說「明確暗戀」。若只有單一宮廷牌、社交牌或情緒牌，不得斷成已經暗戀；只能說「有注意、好感跡象或情緒性關注，但未達明確暗戀」。第三人或公司場域題，若阻礙位出現社交/群體/規範/防備牌，或結果位逆位、退縮、失控、缺乏行動力，必須保守判斷，不可硬說對方會主動。若無宮廷牌或人物牌，不可硬推年齡、外貌、身分或指定一個人。';
  ...
  var FRAG_RECENCY_TAROT =
    '\n' + BAR + '\n交稿前檢查（後半段最容易破功）\n' + BAR +
    '\n□ 牌陣張數與位置讀對 □ 每個位置都已用於回答問題但未逐格報告 □ 只引用本盤合法牌名 □ 壞消息沒有包裝 □ 第一段已直接回答問題 □ 有說明原因、阻礙、時間、24小時行動、可驗證信號 □ 人物/年齡/外貌只在牌面足夠時才推 □ 第三方單身/有對象題已區分證實與推測，沒有把不透明說成一定有伴侶 □ 暗戀/好感題已區分注意/好感跡象與明確暗戀，沒有把單一宮廷/社交/情緒牌放大成確定暗戀 □ 不把現代牌陣說成古典原典 □ 不重複同一結論 □ 能量石只作品牌收尾且不冒充原典\n';
