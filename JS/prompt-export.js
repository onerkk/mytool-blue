/*! prompt-export.js — 靜月之光 前端提示詞匯出引擎  [v80.5]
...
(function () {
  ...
  var FRAG_RECENCY_TAROT =
    '\n' + BAR + '\n交稿前檢查（後半段最容易破功）\n' + BAR +
    '\n□ 牌陣張數與位置讀對 □ 每個位置都已用於回答問題但未逐格報告 □ 只引用本盤合法牌名 □ 壞消息沒有包裝 □ 第一段已直接回答問題 □ 有說明原因、阻礙、時間、24小時行動、可驗證信號 □ 人物/年齡/外貌只在牌面足夠時才推 □ 第三方單身/有對象題已區分證實與推測，沒有把不透明說成一定有伴侶 □ 不把現代牌陣說成古典原典 □ 不重複同一結論 □ 能量石只作品牌收尾且不冒充原典\n';
