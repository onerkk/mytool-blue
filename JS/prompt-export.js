...
(function () {
  ...
  function recommendationFragment(tool) {
    return window.JY_READING_QUALITY&&typeof window.JY_READING_QUALITY.recommendationEnding==="function"&&String(window.JY_READING_QUALITY.version||"0").localeCompare("4.5.0",undefined,{numeric:true})>=0?window.JY_READING_QUALITY.recommendationEnding(tool):JY_REC_EXPORT[tool];
  }
  ...
  function buildPrompt(tool, suppliedPayload) {
    ...
    return [
      ...
      (window.JY_READING_QUALITY&&typeof window.JY_READING_QUALITY.lines==="function"&&String(window.JY_READING_QUALITY.readingVersion||"0").localeCompare("7.0.0",undefined,{numeric:true})>=0?window.JY_READING_QUALITY.lines(tool):JY_READING_EXPORT[tool]).join('\n'),
