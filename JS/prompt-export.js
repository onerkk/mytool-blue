/*! prompt-export.js — 靜月之光 前端提示詞匯出引擎  [v79.0]
 *  v79.0（原典文獻鎖定 + 反幻覺修正）：
...
(function () {
  ...
  var SPREAD_METHODS = {
    ...
    celtic_cross: "本次牌陣：凱爾特十字（10 張）\n【排法出處】A.E. Waite《Pictorial Key to the Tarot》(1910)，「An Ancient Celtic Method of Divination」原文。古典正統。\n讀法：現況核心/交叉牌/根因/近期過去/顯性目標/近期走向/你的位置/外界環境/希望與恐懼/最終結果。核心＋交叉定本質；收束＝最終結果。交叉牌永遠是橫跨現況的力量——好牌＝挑戰不嚴重或反而是有利的橫向影響、壞牌＝真正的阻礙（Waite 原文：shows the nature of the obstacles, if favourable the opposing forces will not be serious）。第七位（你的位置）vs 第八位（環境）矛盾＝內外認知落差。\n⚠ 凱爾特十字讀法鐵律：10 個位置每個都要讀到，不能跳過。尤其：\n・位置 5（你想要的）vs 位置 9（你怕的）必須對比——這組揭示內心矛盾\n・位置 7（你自己）vs 位置 8（外界）必須對比——這組揭示內外認知落差\n・位置 3（根因）不能跳過——它解釋為什麼會走到這步\n・位置 6（短期走向）不能跳過——它是最近可驗證的預測\n不需要每個位置都寫同樣長度，弱位置 1-2 句帶過即可，但不能完全不提。",
    tree_of_life: "本次牌陣：生命之樹（10 張）\n【排法出處】Hermetic Qabalah／Golden Dawn 生命之樹結構應用；卡巴拉骨架正統，具體十張位置牌陣屬神秘學實務應用。\n讀法：先看三柱與上下流動，再看 Tiphereth 核心與 Malkuth 落地。10 個質點都要用到，弱質點一句帶過。",
    zodiac: "本次牌陣：黃道十二宮（12-13 張）\n【排法出處】占星十二宮位系統正統；塔羅逐宮抽牌屬占星塔羅整合應用。宮位含義與三方宮依正統占星。\n讀法：12 宮逐宮掃描，與問題直接相關的宮位深挖，其餘一句帶過；總結牌定整體主旋律。",
    minor_arcana: "本次牌陣：小阿卡那牌陣（7 張）\n【排法出處】現代小牌專題牌陣；正統性靠 Golden Dawn 小牌占星/元素、花色義與具體生活事件判斷。\n讀法：只用 56 張小牌，聚焦日常可改變事件；結果位定走向，建議位給行動。",
    fifteen_card: "本次牌陣：金色黎明十五張（15 張）\n【排法出處】Golden Dawn / Crowley Fifteen-Card Method。古典正統骨架：5 組三張＋元素強弱＋不用逆位。\n讀法：核心三張定本質；自然路徑 vs 替代路徑必須比較；決策層看心理依據；命運線看不可控因素。資料區全為正位是正常，不要找逆位。",
    mathers_21: "本次牌陣：Mathers 二十一張（21 張）\n【排法出處】S.L. MacGregor Mathers《The Tarot》(1888) Methods of Divination 第二法，已對照原文。\n讀法（照 Mathers 原文）：代表牌(Significator)放最右，21 張排成三排七張、由右到左置於代表牌左側：\n　第1排：[代表牌] 1 2 3 4 5 6 7（第1張緊鄰代表牌、第7張最左）\n　第2排：8 9 10 11 12 13 14\n　第3排：15 16 17 18 19 20 21\n① 每排從代表牌開始、由右往左讀成一個連貫句子（依序 1→7、8→14、15→21）。三排接續成完整敘事。\n② 配對讀：再 combine 1↔21、2↔20、3↔19、4↔18、5↔17、6↔16、7↔15、8↔14、9↔13、10↔12（第11張居中、單獨讀）。每對互為補充/因果。\n③ 花色多寡（Mathers 原文）：權杖多＝宴飲歡聚、聖杯多＝戀愛情事、寶劍多＝爭吵麻煩、金幣多＝金錢財務。\n④ ⚠ 此法用逆位（源自 Etteilla 傳統，洗牌時刻意顛倒部分牌）——逆位牌要讀逆位義，不是只靠元素尊嚴。\n⚠ 代表牌依膚色花色選：寶劍最深、金幣次之、聖杯較白、權杖最白；男用國王、女用皇后、少男用騎士、少女用侍者。\n⚠ 三排沒有「過去/現在/未來」固定指派（那是 Mathers 第三法的三角牌陣）——三排是一個連續敘事，不要硬套時間軸。至少列出 3 組重要配對的因果映射。收束＝第三排末＋中心第11張。"
  };
