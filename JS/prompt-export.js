/*! prompt-export.js — 靜月之光 前端提示詞匯出引擎  [v80.61]
...
(function () {
  ...
  function getReadingProcess() {
    ...
    s.push('涉第三人時，先看對方位與宮廷牌；沒有足夠宮廷牌，不硬推年齡、外貌或身分。注意：王牌(Ace)不是宮廷牌——錢幣王牌＝新的物質機會，不是錢幣國王＝某個年長務實的人；只有侍者、騎士、皇后、國王四種宮廷牌才能推人物年齡與身分，王牌絕不可拿來推人。');
    s.push('時間必須由牌面推：資料區時間、GD 占星日期、元素速度、小牌數字階段或大牌事件速度；不可只說「近期」。');
