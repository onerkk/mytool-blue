/*! prompt-export.js — 靜月之光 前端提示詞匯出引擎  [v80.55]
...
(function () {
  ...
  var FRAG_CRYSTAL =
    ...
    '→ 這句看第二次就知道是模板，信任感歸零。\n' +
    '\n⚠ 以下例句只示範「結構與口吻」，禁止照抄任何一句原句（整句搬用＝立刻破功）；石頭的理由必須綁這次盤面實際的花色與失衡，不可套用範例裡的理由。\n✓ 正確（每次不同、有知識、有理由；以下僅為骨架，不可照抄）：\n' +
    ...
    '→ 每句都不同、都有一個「為什麼我挑這個」的知識點、連結自然帶入。\n⚠ 鐵則：石頭只挑一種、只講一次，理由必須點出這次盤面是「哪個元素失衡」並對應到它；禁止照抄上面任何範例句。\n';
