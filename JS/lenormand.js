...
function buildPrompt(question, drawn, spreadId, sigGender) {
  ...
  lines.push('問感情→找心(24)、戒指(25)；問工作職務→找狐狸(14·工作/任務本身)、錨(35·穩定長期的職位)；問升遷・主管・職權→找熊(15·主管/老闆/上位者/權威)、塔(19·體制/公司/職階/官方位階)；問財→找魚(34·金錢流動)、熊(15·資產/財力)；問健康→找大樹(5)；問溝通→找鳥(12)、信(27)；問旅行→找船(3)。※熊(15)雙義：問職權時是「主管/上位者」，問財時是「資產/財力」，依問題定。');
  ...
  lines.push('8. 應期要落地：用距離、速度牌或牌號，給出時間範圍並說出依據（哪張牌定的速度／離核心多遠），禁止只說「快了」，也不要假裝精準到某一天。');
  lines.push('');
