...
function buildPrompt(question, drawn, spreadId, sigGender) {
  ...
  lines.push('・人物牌歸屬（抽出紳士28或淑女29時，凡涉及人物先做這個判斷）：①問卜者已選 28/29 當指示牌＝性別已知——抽出的那張若就是指示牌本身＝問卜者本人；另一張人物牌＝對象或他人。②問卜者沒有以 28/29 自指（性別未知）——抽出的人物牌歸屬未定：正文必須先講明「這張可能是你本人、也可能是你身邊的某位女性／男性，牌面沒有給定」，之後的解讀兩種可能都要照顧到；嚴禁未經聲明直接斷成「另一個女人／另一個男人」。');
  lines.push('');
