// ═══════════════════════════════════════
// 靜月之光 — 雷諾曼牌 Lenormand v2.1
// Petit Lenormand 36 張・傳統組合義讀法・反盤外牌名幻覺
// ═══════════════════════════════════════
(function () {
'use strict';
console.log('[Lenormand] 靜月之光 雷諾曼牌 v2.1 loaded — 原典邊界/本盤合法牌名/反盤外反證修正');
...
function buildPrompt(question, drawn, spreadId, sigGender) {
  ...
  lines.push('小雷諾曼沒有像 Waite/Crowley 那種單一「官方技術文件」；本站採可查文獻邊界：36 張 Petit Lenormand 牌系源於 Das Spiel der Hofnung / Game of Hope 傳統，輸出採傳統組合義、無逆位、遠近與大牌陣讀法；凡屬現代實務補充必須誠實標示，不能冒充原典。');
  lines.push('');
