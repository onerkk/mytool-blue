...
function computeZiwei(year,month,day,hour,gender){
  ...
  return {palaces, mingIdx, shenIdx, yGan, yZhi, wuxingJu, sihua: huaMap, selfHua: selfHuaMap, lunar, mingZhu, shenZhu, mingGan, ziweiIdx, tianfuIdx, daXian, getLiuNianZw};
  } catch(_zwErr) {
    // 顯示在頁面上
    return null;
  }
