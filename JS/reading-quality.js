/* Reading contract v4.2. Evidence-led selection; no default material. Sources in docs/recommendation-audit-20260914.md. Never changes a cast. */
(function(root){
  'use strict';
  ...
  var METHODS={
    tarot:[
      '呈現方式：先給主判與全牌陣的氣氛，再逐張以「牌名・正逆位／本次元素狀態 — 實際牌位」帶入白話解釋，最後串成整副牌的脈絡。大牌陣可依原方法分組，但關鍵牌及其位置不可略過；牌位之間的關係不等於時間順序。',
  ...
  function recommendationPolicy(kinds){return {mode:'needs_first',version:'4.2.0',requiredForValidReading:true,answerStyle:PLAIN_TEXT,outputOrder:['answer','evidence_and_action','personal_material_and_reason','invitation','shop_link','blessing'],outputRule:recommendationText(kinds)+'\n一般情況最後兩行：\n'+SHOP_FOOTER};}
