...
(function(root){
  ...
  function payloadGuide(kinds){
    ...
    return {version:'4.2.0',answerStyle:PLAIN_TEXT,methods:selected,
  ...
  root.JY_READING_QUALITY=Object.freeze({version:'4.2.0',lines:lines,methodLines:methodLines,payloadGuide:payloadGuide,methodKinds:function(){return Object.keys(METHODS);},plainText:function(){return PLAIN_TEXT;},recommendationText:recommendationText,recommendationEnding:recommendationEnding,recommendationPolicy:recommendationPolicy});
