...
function renderMeihua(){
  ...
  html += '<span class="tag" style="background:rgba(212,175,55,.12);color:var(--c-gold);border:1px solid rgba(212,175,55,.2);font-size:.72rem;padding:1px 8px;border-radius:20px;margin-right:4px">' + r.ty.r + '</span>';
  ...
  // 現況
  html += '<div style="' + S1 + 'rgba(212,175,55,.4)">';
  ...
  html += '<div style="' + titleStyle + 'color:#a78bfa">🔍 核心矛盾</div>';
