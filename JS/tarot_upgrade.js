...
function injectSpreadSelector() {
  ...
  var spreads = ['three_card','five_card','cross','either_or','timeline','relationship','celtic_cross','tree_of_life'];
  var labels = {three_card:'3牌',five_card:'5牌',cross:'十字',either_or:'二選一',timeline:'時間線',relationship:'關係',celtic_cross:'凱爾特',tree_of_life:'生命之樹'};
...
(function() {
  ...
  function buildSlotLayout(spreadId, def) {
    if (!def || spreadId === 'celtic_cross' || spreadId === 'tree_of_life') return null;
    var P = def.positions || [];
  ...
  window.initTarotDeck = function() {
    ...
    try {
      ...
      if (descEl) descEl.innerHTML = '凝神冥想你的問題，然後從 <strong class="text-gold">78</strong> 張塔羅牌中選出 <strong class="text-gold">' + targetCount + '</strong> 張牌';
