...
(function() {
  ...
  // ── 硬編保底值(v69.31.0 全面統一定價:標準 100 / 深度 200)──
  //   worker /pricing 端點同步調整,fetch 失敗時用此 fallback
  var HARDCODED_FALLBACK = {
    ...
    OPUS_7D: 200, OPUS_TAROT: 200, OPUS_OOTK: 200,
    OPUS_7D_MEMBER: 200, OPUS_TAROT_MEMBER: 200, OPUS_OOTK_MEMBER: 200,
