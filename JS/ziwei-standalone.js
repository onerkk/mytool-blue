/*! ziwei-standalone.js — 靜月之光 紫微斗數獨立流程  [v80.16]
 *  目的（歐那 2026/6/6）：
...
(function () {
  ...
  function serializeChart(zw, form) {
    ...
    L.push('年干支：' + ((zw.yGan||'') + (zw.yZhi||'')) + '　五行局：' + (zw.wuxingJu||'') + '　命主：' + (zw.mingZhu||'') + '　身主：' + (zw.shenZhu||'') + '　命宮天干：' + (zw.mingGan||''));
...
'④四化是動線不是裝飾：生年四化定先天傾向；自化主漏失、反復、表裡不一；宮干飛化看「這一宮把力量丟去哪一宮、又從哪一宮被牽制」。化忌的去向＝最在意也最容易出事的地方。\n' +
'⑤廟旺利陷定星力：同一顆星廟旺與落陷天差地別；落陷主星＋煞，別當吉論。\n' +
'⑥體用分清：命盤是「體」(一生底色)，大限是「十年的用」，流年是「當年的用」。論運勢要把大限宮位＋流年四化疊到本命宮位上看，不能只報本命。\n' +
'⑦應期要具體：用大限主星、流年四化、流年命宮落點推出「哪一年、最可能哪幾個月」，並說出為什麼是這個時間。禁止只說「快了」「近期」「未來幾年」。\n' +
...
'5. 給可驗證的人事時：對方/貴人/小人是什麼樣的人(由宮位星性與宮職推，例如太陽男性長輩、太陰女性、天機聰明善變者)、會在什麼場合什麼時間出現——要他自己能對照確認。沒有足夠盤面就明說推不出，不硬掰年齡長相。\n' +
'\n' +
'【完整性清單——寫完前自己核對，但不要因此灌水】\n' +
'□ 第一句直接回答了問題\n' +
'□ 定了命格高低與主軸\n' +
'□ 三方四正整體裁決(不是只看本宮)\n' +
'□ 四化動線(尤其化忌去向)有串連展開\n' +
...
'・收尾 2–3 句：依命盤五行喜忌與化忌所在宮位，自然推薦一種適合隨身的水晶/能量石幫他穩住該宮位的弱點(品牌實務輔助，非斗數原理)，語氣平實不推銷，可輕附蝦皮去處 https://tw.shp.ee/9UHEJTp4 。只講一種、只在最後。';
