...
function initTarotDeck(){
  ...
  for(var i=0;i<half;i++){
    ...
    topHtml+='<div class="tarot-deck-card" data-idx="'+i+'" style="--float-delay:'+d+'s"><div class="tarot-deck-card-inner" style="'+bgCss+'"></div></div>';
  }
  for(var i=half;i<deckShuffled.length;i++){
    var d=((i-half)*0.13).toFixed(2);
    var imgUrl=(typeof getTarotCardImage==='function')?getTarotCardImage(deckShuffled[i]):'';
    var bgCss=imgUrl?'background-image:url('+imgUrl+');background-size:cover;background-position:center':'';
    botHtml+='<div class="tarot-deck-card" data-idx="'+i+'" style="--float-delay:'+d+'s"><div class="tarot-deck-card-inner" style="'+bgCss+'"></div></div>';
  }
