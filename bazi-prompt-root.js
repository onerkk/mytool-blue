...
(function (root) {
  ...
  function answerContractLines(mode) {
    ...
    lines=lines.concat(root.JY_READING_QUALITY&&typeof root.JY_READING_QUALITY.lines==="function"&&String(root.JY_READING_QUALITY.readingVersion||"0").localeCompare("8.0.0",undefined,{numeric:true})>=0?root.JY_READING_QUALITY.lines(readingKind):JY_READING_BAZI[readingKind]);
    if(mode==='personality')lines=lines.concat(root.JY_READING_QUALITY&&typeof root.JY_READING_QUALITY.methodLines==="function"&&String(root.JY_READING_QUALITY.readingVersion||"0").localeCompare("8.0.0",undefined,{numeric:true})>=0?root.JY_READING_QUALITY.methodLines('personality'):JY_READING_BAZI.personality);
  ...
  function brandTailLines(mode) {
    ...
    return [
      (root.JY_READING_QUALITY&&typeof root.JY_READING_QUALITY.recommendationEnding==="function"&&String(root.JY_READING_QUALITY.version||"0").localeCompare("4.6.0",undefined,{numeric:true})>=0?root.JY_READING_QUALITY.recommendationText(kind):JY_REC_BAZI[kind]),
      '最後保留以下兩行：\n' + SHOP_LINK + '\n' + FINAL_WISH
    ];
  }
