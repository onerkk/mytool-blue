...
(function() {
  ...
  async function _triggerOOTKAI(results) {
    ...
    wrap.innerHTML = '<div style="text-align:center;padding:2rem 1.2rem 2.3rem">' +
      ...
      '<div style="width:min(260px,80%);height:3px;border-radius:99px;background:rgba(201,168,76,.08);margin:.7rem auto 0;overflow:hidden">' +
        '<div id="ootk-ai-progress" style="width:0%;height:100%;border-radius:99px;background:linear-gradient(90deg,rgba(201,168,76,.6),rgba(22,163,74,.8));transition:width .6s ease"></div>' +
      '</div>' +
