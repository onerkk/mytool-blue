...
function _buildOraclePrompt(poem, qText) {
  ...
  lines.push('');
  lines.push('【延伸選品】');
  lines.push((window.JY_READING_QUALITY&&window.JY_READING_QUALITY.recommendationEnding?window.JY_READING_QUALITY.recommendationText('oracle'):JY_REC_ORACLE));
  lines.push('最後保留以下兩行：');
