...
function _buildOraclePrompt(poem, qText) {
  ...
  lines.push('────────────────');
  lines=lines.concat(window.JY_READING_QUALITY&&typeof window.JY_READING_QUALITY.lines==="function"&&String(window.JY_READING_QUALITY.readingVersion||"0").localeCompare("7.0.0",undefined,{numeric:true})>=0?window.JY_READING_QUALITY.lines('oracle'):JY_READING_ORACLE);
  ...
  lines.push('');
  lines.push((window.JY_READING_QUALITY&&typeof window.JY_READING_QUALITY.recommendationEnding==="function"&&String(window.JY_READING_QUALITY.version||"0").localeCompare("4.5.0",undefined,{numeric:true})>=0?window.JY_READING_QUALITY.recommendationText('oracle'):JY_REC_ORACLE));
  lines.push('最後保留以下兩行：');
