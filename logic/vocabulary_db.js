...
(function (global) {
  ...
  var SUBJECT_BY_TYPE = {
    finance: [
      ...
      '副業銷售', '本月銷售能否破萬', '業績達標', '副業本月收入', '銷售業績'
    ],
    career: [
  ...
  var SUGGESTION_PHRASES = {
    finance: {
      favorable: ['把握投資時機', '可謹慎理財', '開源節流並進', '穩健累積', '正財為主', '副業可積極鋪貨衝量', '把握促銷時機衝銷售'],
      neutral: ['評估現況再行動', '勿過度擴張', '保守理財', '建立預備金', '分散風險', '副業可先穩健經營、留意促銷時機再衝量', '銷售先鋪陳再衝達標'],
      unfavorable: ['保守理財', '避免高槓桿', '檢視支出', '延後大額決策', '穩健為上', '副業暫勿擴張、先穩住再求破萬']
    },
    career: {
